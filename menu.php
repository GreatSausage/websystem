...
<main>
    ...
    <img src="uploaded_img/<?php echo $fetch_products['image']; ?>" alt="" class="image">
         <h6><div class="name"><?php echo $fetch_products['name']; ?></div></h6>
         <h6><div class="price">₱<?php echo $fetch_products['price']; ?>.00</div></h6>
         <h6><div class="details"><?php echo $fetch_products['details']; ?></div></h6>
